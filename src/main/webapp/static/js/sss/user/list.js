layui.use(['table', 'form', 'laydate'], function () {
    ...
    table.render({
        ...
        , cols: [[
            ...
            , {field: 'userName', width: 140, title: '用户姓名', align: 'center'}
            , {field: 'passWord', width: 150, title: '密码', align: 'center'}
            , {field: 'birthday', width: 150, title: '生日', align: 'center'}
        ]]
        // , width: 1200
        , height: 480
        , even: true
    ...
    $("#toEdit").on('click', function () {
        ...
        $.post('toEdit', {id: checkRow.data[0].id}, function (str) {
            layer.open({
                title: ['修改用户', 'color:#009688;font-size:15px;'],
                type: 1,
    ...
    $("#toCreate").on('click', function () {
        ...
        $.get('toCreate', function (str) {
            layer.open({
                title: ['新建用户', 'color:#009688;font-size:15px;'],
                type: 1,
                skin: 'layui-layer-rim', //加上边框
                area: ['900px', '600px'], //宽高
                content: str, //注意，如果str是object，那么需要字符拼接。
